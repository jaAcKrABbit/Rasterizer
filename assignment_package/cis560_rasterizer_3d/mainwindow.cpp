...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_W : rasterizer.camera.MoveForward(0.5); break;
    case Qt::Key_A : rasterizer.camera.MoveRight(-0.5); break;
    case Qt::Key_S : rasterizer.camera.MoveForward(-0.5); break;
    case Qt::Key_D : rasterizer.camera.MoveRight(0.5); break;
    case Qt::Key_Q : rasterizer.camera.MoveUpWard(-0.5); break;
    case Qt::Key_E : rasterizer.camera.MoveUpWard(0.5); break;
    case Qt::Key_Up : rasterizer.camera.RotateX(-5); break;
    case Qt::Key_Down : rasterizer.camera.RotateX(5); break;
    case Qt::Key_Left : rasterizer.camera.RotateY(5); break;
    case Qt::Key_Right : rasterizer.camera.RotateY(-5); break;
    case Qt::Key_Z : rasterizer.camera.RotateZ(5); break;
    case Qt::Key_X : rasterizer.camera.RotateZ(-5); break;
    }
